...
#include <rime/gear/charset_translator.h>
#include <rime/gear/translator_commons.h>

namespace rime {

class CharsetTranslation : public UniqueTranslation {
 public:
  CharsetTranslation(const an<Candidate>& candidate)
...
CharsetTranslator::CharsetTranslator(const Ticket& ticket)
...
void CharsetTranslator::Initialize() {
...
an<Translation> CharsetTranslator::Query(const string& input,
  ...
  auto candidate = New<SimpleCandidate>("raw",
                                        ...
                                        segment.end,
                                        s);
  return New<CharsetTranslation>(candidate);
}
